...
print(f"---------------------------")
print(f"Khan: {khan_percent:.0%} ({khan_votes})")
print(f"Correy: {correy_percent:.0%} ({correy_votes})")
print(f"Li: {li_percent:.0%} ({li_votes})")
print(f"O'Tooley: {otooley_percent:.0%} ({otooley_votes})")
print(f"---------------------------")
